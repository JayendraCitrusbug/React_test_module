...
const SubCategory = () => {
    ...
    useEffect(() => {
        axios({
            url: "http://43.204.196.131:9300/api/v1/subcategory/",
            method: "GET",
            headers: {
                "Authorization": `${token}`,
            }
    ...
    return (
        <li className="cf_submenu_block">
            {/* <a href="javascript:;" className="menu_scrl"><span className="cf_icon cf_crops"></span><label>Crops</label><span
                className="cf_icon cf_down"></span></a>
            <ul className="cf_sidebar_submenu">
                <li><a href="us_sales.html">US Sales</a></li>
                <li><a href="javascript:;">US Inspections</a></li>
                <li><a href="javascript:;">USDA Flash</a></li>
                <li><a href="javascript:;">EU Weekly Trade Data</a></li>
                <li><a href="javascript:;">Lineup Data</a></li>
                <li><a href="javascript:;">Tender Data</a></li>
                <li><a href="javascript:;">Custom Data</a></li>
            </ul> */}
        </li>
